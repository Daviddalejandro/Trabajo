...
CATALOGS: dict[str, tuple[str, str, str | None, bool, list]] = {
    ...
    "CAT_RELATIONSHIP_TYPE": ("DEMOGRAPHICS", "Tipo de relación entre parties (con dirección)", "Interno", False, [
        ...
        ("GUARANTOR_OF", "Codeudor de", None, {"from_party_type": "ANY", "to_party_type": "ANY", "inverse_code": "GUARANTEED_BY"}),
        ("GUARANTEED_BY", "Garantizado por (codeudor)", None, {"from_party_type": "ANY", "to_party_type": "ANY", "inverse_code": "GUARANTOR_OF"}),
...
SOURCE_SYSTEMS = [
    ...
    ("CREDITO_CORE", "Sistema de crédito · core de cartera (clientes, obligaciones, gestión de cobranza)", True, "Gerencia de Crédito Social", "steward.credito"),
]
...
MAPPINGS = [
    ...
    # CREDITO_CORE (conjunto de validación): identificación, sexo, productos, estados, calificación, teléfonos de gestión, fallecido
    ("CREDITO_CORE", "TIPO_ID", "CAT_ID_TYPE", "C", "CC"),
    ("CREDITO_CORE", "TIPO_ID", "CAT_ID_TYPE", "E", "CE"),
    ("CREDITO_CORE", "TIPO_ID", "CAT_ID_TYPE", "T", "TI"),
    ("CREDITO_CORE", "TIPO_ID", "CAT_ID_TYPE", "P", "PAS"),
    ("CREDITO_CORE", "TIPO_ID", "CAT_ID_TYPE", "N", "NIT"),
    ("CREDITO_CORE", "SEXO", "CAT_GENDER", "H", "M"),
    ("CREDITO_CORE", "SEXO", "CAT_GENDER", "M", "F"),
    ("CREDITO_CORE", "PRODUCTO", "CAT_SERVICE", "CS", "CREDITO_SOCIAL"),
    ("CREDITO_CORE", "PRODUCTO", "CAT_SERVICE", "TC", "TARJETA_CREDITO"),
    ("CREDITO_CORE", "ESTADO_OBLIG", "CAT_ENROLLMENT_STATUS", "VIG", "ACTIVE"),
    ("CREDITO_CORE", "ESTADO_OBLIG", "CAT_ENROLLMENT_STATUS", "MOR", "SUSPENDED"),
    ("CREDITO_CORE", "ESTADO_OBLIG", "CAT_ENROLLMENT_STATUS", "CAN", "CLOSED"),
    ("CREDITO_CORE", "CALIFICACION", "CAT_SEGMENT_TYPE", "A", "LOW"),
    ("CREDITO_CORE", "CALIFICACION", "CAT_SEGMENT_TYPE", "B", "LOW"),
    ("CREDITO_CORE", "CALIFICACION", "CAT_SEGMENT_TYPE", "C", "MEDIUM"),
    ("CREDITO_CORE", "CALIFICACION", "CAT_SEGMENT_TYPE", "D", "HIGH"),
    ("CREDITO_CORE", "CALIFICACION", "CAT_SEGMENT_TYPE", "E", "HIGH"),
    ("CREDITO_CORE", "TIPO_TEL", "CAT_CONTACT_USAGE_ROLE", "TIT", "OWNER"),
    ("CREDITO_CORE", "TIPO_TEL", "CAT_CONTACT_USAGE_ROLE", "REF", "REFERENCE"),
    ("CREDITO_CORE", "ESTADO_TEL", "CAT_CONTACT_CONFIRMATION", "CONF", "CONFIRMED_BY_TITULAR"),
    ("CREDITO_CORE", "ESTADO_TEL", "CAT_CONTACT_CONFIRMATION", "NOCONF", "UNCONFIRMED"),
    ("CREDITO_CORE", "ESTADO_TEL", "CAT_CONTACT_CONFIRMATION", "ERR", "WRONG_PERSON"),
    ("CREDITO_CORE", "FALLECIDO", "CAT_PARTY_STATUS", "S", "DECEASED"),
