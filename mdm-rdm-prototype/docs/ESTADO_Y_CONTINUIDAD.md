...
| Vitrina y cargas | `make showcase` (S1–S7 en DELTA), carga transaccional TX por API, modelo relacional y buckets en `#/modelo` | Completa | `tests/test_showcase.py` (3), `docs/evidence/f4/18–19`, DEMO.md «Vitrina» |
